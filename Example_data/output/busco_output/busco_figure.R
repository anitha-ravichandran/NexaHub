...
# Output
my_output <- paste("/home/altschul/Pictures/data/Out/busco_output/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('busco_result', 'busco_result', 'busco_result', 'busco_result')
...
my_percentage <- c(0.0, 0.0, 0.0, 100.0)
my_values <- c(0, 0, 0, 655)
